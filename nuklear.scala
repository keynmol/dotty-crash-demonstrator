...
object types:
  ...
  opaque type _dummy_array5818 = CArray[CChar, Nat._1]
  object _dummy_array5818: 
    given _tag: Tag[_dummy_array5818] = Tag.CArray[CChar, Nat._1](Tag.Byte, Tag.Nat1)
    inline def apply(inline o: CArray[CChar, Nat._1]): _dummy_array5818 = o

  opaque type _dummy_array5819 = CArray[CChar, Nat._1]
  object _dummy_array5819: 
    given _tag: Tag[_dummy_array5819] = Tag.CArray[CChar, Nat._1](Tag.Byte, Tag.Nat1)
    inline def apply(inline o: CArray[CChar, Nat._1]): _dummy_array5819 = o

  opaque type _dummy_array5820 = CArray[CChar, Nat._1]
  object _dummy_array5820: 
    given _tag: Tag[_dummy_array5820] = Tag.CArray[CChar, Nat._1](Tag.Byte, Tag.Nat1)
    inline def apply(inline o: CArray[CChar, Nat._1]): _dummy_array5820 = o

  opaque type _dummy_array5824 = CArray[CChar, Nat._1]
  object _dummy_array5824: 
    given _tag: Tag[_dummy_array5824] = Tag.CArray[CChar, Nat._1](Tag.Byte, Tag.Nat1)
    inline def apply(inline o: CArray[CChar, Nat._1]): _dummy_array5824 = o
...
@extern
private[nuklear] object extern_functions:
  import types.*
  private[nuklear] def __sn_wrap_nuklear_nk_begin(ctx : Ptr[nk_context], title : CString, bounds : Ptr[nk_rect], flags : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_begin_titled(ctx : Ptr[nk_context], name : CString, title : CString, bounds : Ptr[nk_rect], flags : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_button_behavior(state : Ptr[nk_flags], r : Ptr[nk_rect], i : Ptr[nk_input], behavior : nk_button_behavior): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_button_color(ctx : Ptr[nk_context], color : Ptr[nk_color]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_button_image(ctx : Ptr[nk_context], img : Ptr[nk_image]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_button_image_label(ctx : Ptr[nk_context], img : Ptr[nk_image], label : CString, align : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_button_image_label_styled(ctx : Ptr[nk_context], style : Ptr[nk_style_button], img : Ptr[nk_image], label : CString, text_alignment : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_button_image_styled(ctx : Ptr[nk_context], style : Ptr[nk_style_button], img : Ptr[nk_image]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_button_image_text(ctx : Ptr[nk_context], img : Ptr[nk_image], text : CString, len : CInt, align : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_button_image_text_styled(ctx : Ptr[nk_context], style : Ptr[nk_style_button], img : Ptr[nk_image], text : CString, len : CInt, align : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_chart_add_slot_colored(ctx : Ptr[nk_context], `type` : nk_chart_type, color : Ptr[nk_color], highlight : Ptr[nk_color], count : CInt, min_value : Float, max_value : Float): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_chart_begin_colored(ctx : Ptr[nk_context], `type` : nk_chart_type, color : Ptr[nk_color], highlight : Ptr[nk_color], count : CInt, min_value : Float, max_value : Float): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_cf(in : Ptr[nk_color], __return : Ptr[nk_colorf]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_d(r : Ptr[Double], g : Ptr[Double], b : Ptr[Double], a : Ptr[Double], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_dv(c : Ptr[Double], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_f(r : Ptr[Float], g : Ptr[Float], b : Ptr[Float], a : Ptr[Float], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_fv(c : Ptr[Float], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hex_rgb(output : CString, col : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hex_rgba(output : CString, col : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsv_b(out_h : Ptr[nk_byte], out_s : Ptr[nk_byte], out_v : Ptr[nk_byte], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsv_bv(out : Ptr[nk_byte], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsv_f(out_h : Ptr[Float], out_s : Ptr[Float], out_v : Ptr[Float], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsv_fv(out : Ptr[Float], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsv_i(out_h : Ptr[CInt], out_s : Ptr[CInt], out_v : Ptr[CInt], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsv_iv(out : Ptr[CInt], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsva_b(h : Ptr[nk_byte], s : Ptr[nk_byte], v : Ptr[nk_byte], a : Ptr[nk_byte], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsva_bv(out : Ptr[nk_byte], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsva_f(out_h : Ptr[Float], out_s : Ptr[Float], out_v : Ptr[Float], out_a : Ptr[Float], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsva_fv(out : Ptr[Float], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsva_i(out_h : Ptr[CInt], out_s : Ptr[CInt], out_v : Ptr[CInt], out_a : Ptr[CInt], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_hsva_iv(out : Ptr[CInt], in : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_picker(ctx : Ptr[nk_context], color : Ptr[nk_colorf], fmt : nk_color_format, __return : Ptr[nk_colorf]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_color_u32(in : Ptr[nk_color]): nk_uint = extern

  private[nuklear] def __sn_wrap_nuklear_nk_colorf_hsva_f(out_h : Ptr[Float], out_s : Ptr[Float], out_v : Ptr[Float], out_a : Ptr[Float], in : Ptr[nk_colorf]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_colorf_hsva_fv(hsva : Ptr[Float], in : Ptr[nk_colorf]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo(ctx : Ptr[nk_context], items : Ptr[CString], count : CInt, selected : CInt, item_height : CInt, size : Ptr[nk_vec2]): CInt = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_begin(ctx : Ptr[nk_context], win : Ptr[nk_window], size : Ptr[nk_vec2], is_clicked : nk_bool, header : Ptr[nk_rect]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_begin_color(ctx : Ptr[nk_context], color : Ptr[nk_color], size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_begin_image(ctx : Ptr[nk_context], img : Ptr[nk_image], size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_begin_image_label(ctx : Ptr[nk_context], selected : CString, img : Ptr[nk_image], size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_begin_image_text(ctx : Ptr[nk_context], selected : CString, len : CInt, img : Ptr[nk_image], size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_begin_label(ctx : Ptr[nk_context], selected : CString, size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_begin_symbol(ctx : Ptr[nk_context], symbol : nk_symbol_type, size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_begin_symbol_label(ctx : Ptr[nk_context], selected : CString, `type` : nk_symbol_type, size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_begin_symbol_text(ctx : Ptr[nk_context], selected : CString, len : CInt, symbol : nk_symbol_type, size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_begin_text(ctx : Ptr[nk_context], selected : CString, len : CInt, size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_callback(ctx : Ptr[nk_context], item_getter : CFuncPtr3[Ptr[Byte], CInt, Ptr[CString], Unit], userdata : Ptr[Byte], selected : CInt, count : CInt, item_height : CInt, size : Ptr[nk_vec2]): CInt = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_item_image_label(ctx : Ptr[nk_context], img : Ptr[nk_image], text : CString, alignment : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_item_image_text(ctx : Ptr[nk_context], img : Ptr[nk_image], text : CString, len : CInt, alignment : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_separator(ctx : Ptr[nk_context], items_separated_by_separator : CString, separator : CInt, selected : CInt, count : CInt, item_height : CInt, size : Ptr[nk_vec2]): CInt = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combo_string(ctx : Ptr[nk_context], items_separated_by_zeros : CString, selected : CInt, count : CInt, item_height : CInt, size : Ptr[nk_vec2]): CInt = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combobox(ctx : Ptr[nk_context], items : Ptr[CString], count : CInt, selected : Ptr[CInt], item_height : CInt, size : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combobox_callback(ctx : Ptr[nk_context], item_getter : CFuncPtr3[Ptr[Byte], CInt, Ptr[CString], Unit], userdata : Ptr[Byte], selected : Ptr[CInt], count : CInt, item_height : CInt, size : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combobox_separator(ctx : Ptr[nk_context], items_separated_by_separator : CString, separator : CInt, selected : Ptr[CInt], count : CInt, item_height : CInt, size : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_combobox_string(ctx : Ptr[nk_context], items_separated_by_zeros : CString, selected : Ptr[CInt], count : CInt, item_height : CInt, size : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_contextual_begin(ctx : Ptr[nk_context], flags : nk_flags, size : Ptr[nk_vec2], trigger_bounds : Ptr[nk_rect]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_contextual_item_image_label(ctx : Ptr[nk_context], img : Ptr[nk_image], label : CString, align : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_contextual_item_image_text(ctx : Ptr[nk_context], img : Ptr[nk_image], text : CString, len : CInt, align : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_button(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], r : Ptr[nk_rect], style : Ptr[nk_style_button], in : Ptr[nk_input], behavior : nk_button_behavior, content : Ptr[nk_rect]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_button_image(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], img : Ptr[nk_image], b : nk_button_behavior, style : Ptr[nk_style_button], in : Ptr[nk_input]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_button_symbol(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], symbol : nk_symbol_type, behavior : nk_button_behavior, style : Ptr[nk_style_button], in : Ptr[nk_input], font : Ptr[nk_user_font]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_button_text(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], string : CString, len : CInt, align : nk_flags, behavior : nk_button_behavior, style : Ptr[nk_style_button], in : Ptr[nk_input], font : Ptr[nk_user_font]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_button_text_image(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], img : Ptr[nk_image], str : CString, len : CInt, align : nk_flags, behavior : nk_button_behavior, style : Ptr[nk_style_button], font : Ptr[nk_user_font], in : Ptr[nk_input]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_button_text_symbol(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], symbol : nk_symbol_type, str : CString, len : CInt, align : nk_flags, behavior : nk_button_behavior, style : Ptr[nk_style_button], font : Ptr[nk_user_font], in : Ptr[nk_input]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_color_picker(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], col : Ptr[nk_colorf], fmt : nk_color_format, bounds : Ptr[nk_rect], padding : Ptr[nk_vec2], in : Ptr[nk_input], font : Ptr[nk_user_font]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_edit(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], flags : nk_flags, filter : nk_plugin_filter, edit : Ptr[nk_text_edit], style : Ptr[nk_style_edit], in : Ptr[nk_input], font : Ptr[nk_user_font]): nk_flags = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_progress(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], value : nk_size, max : nk_size, modifiable : nk_bool, style : Ptr[nk_style_progress], in : Ptr[nk_input]): nk_size = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_property(ws : Ptr[nk_flags], out : Ptr[nk_command_buffer], property : Ptr[nk_rect], name : CString, variant : Ptr[nk_property_variant], inc_per_pixel : Float, buffer : CString, len : Ptr[CInt], state : Ptr[CInt], cursor : Ptr[CInt], select_begin : Ptr[CInt], select_end : Ptr[CInt], style : Ptr[nk_style_property], filter : nk_property_filter, in : Ptr[nk_input], font : Ptr[nk_user_font], text_edit : Ptr[nk_text_edit], behavior : nk_button_behavior): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_scrollbarh(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], scroll : Ptr[nk_rect], has_scrolling : CInt, offset : Float, target : Float, step : Float, button_pixel_inc : Float, style : Ptr[nk_style_scrollbar], in : Ptr[nk_input], font : Ptr[nk_user_font]): Float = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_scrollbarv(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], scroll : Ptr[nk_rect], has_scrolling : CInt, offset : Float, target : Float, step : Float, button_pixel_inc : Float, style : Ptr[nk_style_scrollbar], in : Ptr[nk_input], font : Ptr[nk_user_font]): Float = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_selectable(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], str : CString, len : CInt, align : nk_flags, value : Ptr[nk_bool], style : Ptr[nk_style_selectable], in : Ptr[nk_input], font : Ptr[nk_user_font]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_selectable_image(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], str : CString, len : CInt, align : nk_flags, value : Ptr[nk_bool], img : Ptr[nk_image], style : Ptr[nk_style_selectable], in : Ptr[nk_input], font : Ptr[nk_user_font]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_selectable_symbol(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], str : CString, len : CInt, align : nk_flags, value : Ptr[nk_bool], sym : nk_symbol_type, style : Ptr[nk_style_selectable], in : Ptr[nk_input], font : Ptr[nk_user_font]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_slider(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : Ptr[nk_rect], min : Float, `val` : Float, max : Float, step : Float, style : Ptr[nk_style_slider], in : Ptr[nk_input], font : Ptr[nk_user_font]): Float = extern

  private[nuklear] def __sn_wrap_nuklear_nk_do_toggle(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], r : Ptr[nk_rect], active : Ptr[nk_bool], str : CString, len : CInt, `type` : nk_toggle_type, style : Ptr[nk_style_toggle], in : Ptr[nk_input], font : Ptr[nk_user_font]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_drag_behavior(state : Ptr[nk_flags], in : Ptr[nk_input], drag : Ptr[nk_rect], variant : Ptr[nk_property_variant], inc_per_pixel : Float): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_draw_color_picker(o : Ptr[nk_command_buffer], matrix : Ptr[nk_rect], hue_bar : Ptr[nk_rect], alpha_bar : Ptr[nk_rect], col : Ptr[nk_colorf]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_draw_image(b : Ptr[nk_command_buffer], r : Ptr[nk_rect], img : Ptr[nk_image], col : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_draw_nine_slice(b : Ptr[nk_command_buffer], r : Ptr[nk_rect], slc : Ptr[nk_nine_slice], col : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_draw_symbol(out : Ptr[nk_command_buffer], `type` : nk_symbol_type, content : Ptr[nk_rect], background : Ptr[nk_color], foreground : Ptr[nk_color], border_width : Float, font : Ptr[nk_user_font]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_draw_text(b : Ptr[nk_command_buffer], r : Ptr[nk_rect], string : CString, length : CInt, font : Ptr[nk_user_font], bg : Ptr[nk_color], fg : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_edit_draw_text(out : Ptr[nk_command_buffer], style : Ptr[nk_style_edit], pos_x : Float, pos_y : Float, x_offset : Float, text : CString, byte_len : CInt, row_height : Float, font : Ptr[nk_user_font], background : Ptr[nk_color], foreground : Ptr[nk_color], is_selected : nk_bool): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_fill_arc(b : Ptr[nk_command_buffer], cx : Float, cy : Float, radius : Float, a_min : Float, a_max : Float, c : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_fill_circle(b : Ptr[nk_command_buffer], r : Ptr[nk_rect], c : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_fill_polygon(b : Ptr[nk_command_buffer], points : Ptr[Float], point_count : CInt, col : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_fill_rect(b : Ptr[nk_command_buffer], rect : Ptr[nk_rect], rounding : Float, c : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_fill_rect_multi_color(b : Ptr[nk_command_buffer], rect : Ptr[nk_rect], left : Ptr[nk_color], top : Ptr[nk_color], right : Ptr[nk_color], bottom : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_fill_triangle(b : Ptr[nk_command_buffer], x0 : Float, y0 : Float, x1 : Float, y1 : Float, x2 : Float, y2 : Float, c : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_get_null_rect(__return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsv(h : CInt, s : CInt, v : CInt, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsv_bv(c : Ptr[nk_byte], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsv_f(h : Float, s : Float, v : Float, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsv_fv(c : Ptr[Float], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsv_iv(c : Ptr[CInt], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsva(h : CInt, s : CInt, v : CInt, a : CInt, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsva_bv(c : Ptr[nk_byte], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsva_colorf(h : Float, s : Float, v : Float, a : Float, __return : Ptr[nk_colorf]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsva_colorfv(c : Ptr[Float], __return : Ptr[nk_colorf]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsva_f(h : Float, s : Float, v : Float, a : Float, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsva_fv(c : Ptr[Float], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_hsva_iv(c : Ptr[CInt], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_image(ctx : Ptr[nk_context], img : Ptr[nk_image]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_image_color(ctx : Ptr[nk_context], img : Ptr[nk_image], col : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_image_handle(handle : nk_handle, __return : Ptr[nk_image]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_image_id(id : CInt, __return : Ptr[nk_image]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_image_ptr(ptr : Ptr[Byte], __return : Ptr[nk_image]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_input_any_mouse_click_in_rect(in : Ptr[nk_input], b : Ptr[nk_rect]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_input_has_mouse_click_down_in_rect(i : Ptr[nk_input], id : nk_buttons, b : Ptr[nk_rect], down : nk_bool): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_input_has_mouse_click_in_rect(i : Ptr[nk_input], id : nk_buttons, b : Ptr[nk_rect]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_input_is_mouse_click_down_in_rect(i : Ptr[nk_input], id : nk_buttons, b : Ptr[nk_rect], down : nk_bool): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_input_is_mouse_click_in_rect(i : Ptr[nk_input], id : nk_buttons, b : Ptr[nk_rect]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_input_is_mouse_hovering_rect(i : Ptr[nk_input], rect : Ptr[nk_rect]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_input_is_mouse_prev_hovering_rect(i : Ptr[nk_input], rect : Ptr[nk_rect]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_input_mouse_clicked(i : Ptr[nk_input], id : nk_buttons, rect : Ptr[nk_rect]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_input_scroll(ctx : Ptr[nk_context], `val` : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_label_colored(ctx : Ptr[nk_context], str : CString, align : nk_flags, color : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_label_colored_wrap(ctx : Ptr[nk_context], str : CString, color : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_layout_space_bounds(ctx : Ptr[nk_context], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_layout_space_push(ctx : Ptr[nk_context], rect : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_layout_space_rect_to_local(ctx : Ptr[nk_context], ret : Ptr[nk_rect], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_layout_space_rect_to_screen(ctx : Ptr[nk_context], ret : Ptr[nk_rect], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_layout_space_to_local(ctx : Ptr[nk_context], ret : Ptr[nk_vec2], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_layout_space_to_screen(ctx : Ptr[nk_context], ret : Ptr[nk_vec2], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_layout_widget_bounds(ctx : Ptr[nk_context], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_begin(ctx : Ptr[nk_context], win : Ptr[nk_window], id : CString, is_clicked : CInt, header : Ptr[nk_rect], size : Ptr[nk_vec2]): CInt = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_begin_image(ctx : Ptr[nk_context], id : CString, img : Ptr[nk_image], size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_begin_image_label(ctx : Ptr[nk_context], title : CString, align : nk_flags, img : Ptr[nk_image], size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_begin_image_text(ctx : Ptr[nk_context], title : CString, len : CInt, align : nk_flags, img : Ptr[nk_image], size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_begin_label(ctx : Ptr[nk_context], text : CString, align : nk_flags, size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_begin_symbol(ctx : Ptr[nk_context], id : CString, sym : nk_symbol_type, size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_begin_symbol_label(ctx : Ptr[nk_context], title : CString, align : nk_flags, sym : nk_symbol_type, size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_begin_symbol_text(ctx : Ptr[nk_context], title : CString, len : CInt, align : nk_flags, sym : nk_symbol_type, size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_begin_text(ctx : Ptr[nk_context], title : CString, len : CInt, align : nk_flags, size : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_item_image_label(ctx : Ptr[nk_context], img : Ptr[nk_image], label : CString, align : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_menu_item_image_text(ctx : Ptr[nk_context], img : Ptr[nk_image], text : CString, len : CInt, align : nk_flags): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_nine_slice_handle(handle : nk_handle, l : nk_ushort, t : nk_ushort, r : nk_ushort, b : nk_ushort, __return : Ptr[nk_nine_slice]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_nine_slice_id(id : CInt, l : nk_ushort, t : nk_ushort, r : nk_ushort, b : nk_ushort, __return : Ptr[nk_nine_slice]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_nine_slice_ptr(ptr : Ptr[Byte], l : nk_ushort, t : nk_ushort, r : nk_ushort, b : nk_ushort, __return : Ptr[nk_nine_slice]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_nonblock_begin(ctx : Ptr[nk_context], flags : nk_flags, body : Ptr[nk_rect], header : Ptr[nk_rect], panel_type : nk_panel_type): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_pad_rect(r : Ptr[nk_rect], pad : Ptr[nk_vec2], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_panel_get_border_color(style : Ptr[nk_style], `type` : nk_panel_type, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_panel_get_padding(style : Ptr[nk_style], `type` : nk_panel_type, __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_popup_begin(ctx : Ptr[nk_context], `type` : nk_popup_type, title : CString, flags : nk_flags, rect : Ptr[nk_rect]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_progress_behavior(state : Ptr[nk_flags], in : Ptr[nk_input], r : Ptr[nk_rect], cursor : Ptr[nk_rect], max : nk_size, value : nk_size, modifiable : nk_bool): nk_size = extern

  private[nuklear] def __sn_wrap_nuklear_nk_property_behavior(ws : Ptr[nk_flags], in : Ptr[nk_input], property : Ptr[nk_rect], label : Ptr[nk_rect], edit : Ptr[nk_rect], empty : Ptr[nk_rect], state : Ptr[CInt], variant : Ptr[nk_property_variant], inc_per_pixel : Float): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_property_variant_double(value : Double, min_value : Double, max_value : Double, step : Double, __return : Ptr[nk_property_variant]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_property_variant_float(value : Float, min_value : Float, max_value : Float, step : Float, __return : Ptr[nk_property_variant]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_property_variant_int(value : CInt, min_value : CInt, max_value : CInt, step : CInt, __return : Ptr[nk_property_variant]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_push_custom(b : Ptr[nk_command_buffer], r : Ptr[nk_rect], cb : nk_command_custom_callback, usr : nk_handle): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_push_scissor(b : Ptr[nk_command_buffer], r : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rect(x : Float, y : Float, w : Float, h : Float, __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rect_pos(r : Ptr[nk_rect], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rect_size(r : Ptr[nk_rect], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_recta(pos : Ptr[nk_vec2], size : Ptr[nk_vec2], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_recti(x : CInt, y : CInt, w : CInt, h : CInt, __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rectiv(r : Ptr[CInt], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rectv(r : Ptr[Float], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgb(r : CInt, g : CInt, b : CInt, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgb_bv(c : Ptr[nk_byte], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgb_cf(c : Ptr[nk_colorf], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgb_f(r : Float, g : Float, b : Float, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgb_fv(c : Ptr[Float], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgb_hex(rgb : CString, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgb_iv(c : Ptr[CInt], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgba(r : CInt, g : CInt, b : CInt, a : CInt, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgba_bv(c : Ptr[nk_byte], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgba_cf(c : Ptr[nk_colorf], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgba_f(r : Float, g : Float, b : Float, a : Float, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgba_fv(c : Ptr[Float], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgba_hex(rgb : CString, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgba_iv(c : Ptr[CInt], __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_rgba_u32(in : nk_uint, __return : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_select_image_label(ctx : Ptr[nk_context], img : Ptr[nk_image], str : CString, align : nk_flags, value : nk_bool): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_select_image_text(ctx : Ptr[nk_context], img : Ptr[nk_image], str : CString, len : CInt, align : nk_flags, value : nk_bool): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_selectable_image_label(ctx : Ptr[nk_context], img : Ptr[nk_image], str : CString, align : nk_flags, value : Ptr[nk_bool]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_selectable_image_text(ctx : Ptr[nk_context], img : Ptr[nk_image], str : CString, len : CInt, align : nk_flags, value : Ptr[nk_bool]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_shrink_rect(r : Ptr[nk_rect], amount : Float, __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_slider_behavior(state : Ptr[nk_flags], logical_cursor : Ptr[nk_rect], visual_cursor : Ptr[nk_rect], in : Ptr[nk_input], bounds : Ptr[nk_rect], slider_min : Float, slider_max : Float, slider_value : Float, slider_step : Float, slider_steps : Float): Float = extern

  private[nuklear] def __sn_wrap_nuklear_nk_stroke_arc(b : Ptr[nk_command_buffer], cx : Float, cy : Float, radius : Float, a_min : Float, a_max : Float, line_thickness : Float, c : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_stroke_circle(b : Ptr[nk_command_buffer], r : Ptr[nk_rect], line_thickness : Float, c : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_stroke_curve(b : Ptr[nk_command_buffer], ax : Float, ay : Float, ctrl0x : Float, ctrl0y : Float, ctrl1x : Float, ctrl1y : Float, bx : Float, by : Float, line_thickness : Float, col : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_stroke_line(b : Ptr[nk_command_buffer], x0 : Float, y0 : Float, x1 : Float, y1 : Float, line_thickness : Float, c : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_stroke_polygon(b : Ptr[nk_command_buffer], points : Ptr[Float], point_count : CInt, line_thickness : Float, col : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_stroke_polyline(b : Ptr[nk_command_buffer], points : Ptr[Float], point_count : CInt, line_thickness : Float, col : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_stroke_rect(b : Ptr[nk_command_buffer], rect : Ptr[nk_rect], rounding : Float, line_thickness : Float, c : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_stroke_triangle(b : Ptr[nk_command_buffer], x0 : Float, y0 : Float, x1 : Float, y1 : Float, x2 : Float, y2 : Float, line_thickness : Float, c : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_style_item_color(col : Ptr[nk_color], __return : Ptr[nk_style_item]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_style_item_hide(__return : Ptr[nk_style_item]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_style_item_image(img : Ptr[nk_image], __return : Ptr[nk_style_item]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_style_item_nine_slice(slice : Ptr[nk_nine_slice], __return : Ptr[nk_style_item]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_style_push_color(ctx : Ptr[nk_context], address : Ptr[nk_color], value : Ptr[nk_color]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_style_push_style_item(ctx : Ptr[nk_context], address : Ptr[nk_style_item], value : Ptr[nk_style_item]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_style_push_vec2(ctx : Ptr[nk_context], address : Ptr[nk_vec2], value : Ptr[nk_vec2]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_sub9slice_handle(handle : nk_handle, w : nk_ushort, h : nk_ushort, rgn : Ptr[nk_rect], l : nk_ushort, t : nk_ushort, r : nk_ushort, b : nk_ushort, __return : Ptr[nk_nine_slice]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_sub9slice_id(id : CInt, w : nk_ushort, h : nk_ushort, rgn : Ptr[nk_rect], l : nk_ushort, t : nk_ushort, r : nk_ushort, b : nk_ushort, __return : Ptr[nk_nine_slice]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_sub9slice_ptr(ptr : Ptr[Byte], w : nk_ushort, h : nk_ushort, rgn : Ptr[nk_rect], l : nk_ushort, t : nk_ushort, r : nk_ushort, b : nk_ushort, __return : Ptr[nk_nine_slice]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_subimage_handle(handle : nk_handle, w : nk_ushort, h : nk_ushort, r : Ptr[nk_rect], __return : Ptr[nk_image]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_subimage_id(id : CInt, w : nk_ushort, h : nk_ushort, r : Ptr[nk_rect], __return : Ptr[nk_image]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_subimage_ptr(ptr : Ptr[Byte], w : nk_ushort, h : nk_ushort, r : Ptr[nk_rect], __return : Ptr[nk_image]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_text_calculate_text_bounds(font : Ptr[nk_user_font], begin : CString, byte_len : CInt, row_height : Float, remaining : Ptr[CString], out_offset : Ptr[nk_vec2], glyphs : Ptr[CInt], op : CInt, __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_text_colored(ctx : Ptr[nk_context], str : CString, len : CInt, alignment : nk_flags, color : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_text_wrap_colored(ctx : Ptr[nk_context], str : CString, len : CInt, color : Ptr[nk_color]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_toggle_behavior(in : Ptr[nk_input], select : Ptr[nk_rect], state : Ptr[nk_flags], active : nk_bool): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_tree_element_image_push_hashed(ctx : Ptr[nk_context], `type` : nk_tree_type, img : Ptr[nk_image], title : CString, initial_state : nk_collapse_states, selected : Ptr[nk_bool], hash : CString, len : CInt, seed : CInt): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_tree_image_push_hashed(ctx : Ptr[nk_context], `type` : nk_tree_type, img : Ptr[nk_image], title : CString, initial_state : nk_collapse_states, hash : CString, len : CInt, seed : CInt): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_tree_state_image_push(ctx : Ptr[nk_context], `type` : nk_tree_type, img : Ptr[nk_image], title : CString, state : Ptr[nk_collapse_states]): nk_bool = extern

  private[nuklear] def __sn_wrap_nuklear_nk_triangle_from_direction(result : Ptr[nk_vec2], r : Ptr[nk_rect], pad_x : Float, pad_y : Float, direction : nk_heading): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_vec2(x : Float, y : Float, __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_vec2i(x : CInt, y : CInt, __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_vec2iv(v : Ptr[CInt], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_vec2v(v : Ptr[Float], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_widget_bounds(ctx : Ptr[nk_context], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_widget_fitting(bounds : Ptr[nk_rect], ctx : Ptr[nk_context], item_padding : Ptr[nk_vec2]): nk_widget_layout_states = extern

  private[nuklear] def __sn_wrap_nuklear_nk_widget_position(ctx : Ptr[nk_context], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_widget_size(ctx : Ptr[nk_context], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_widget_text(o : Ptr[nk_command_buffer], b : Ptr[nk_rect], string : CString, len : CInt, t : Ptr[nk_text], a : nk_flags, f : Ptr[nk_user_font]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_widget_text_wrap(o : Ptr[nk_command_buffer], b : Ptr[nk_rect], string : CString, len : CInt, t : Ptr[nk_text], f : Ptr[nk_user_font]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_window_get_bounds(ctx : Ptr[nk_context], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_window_get_content_region(ctx : Ptr[nk_context], __return : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_window_get_content_region_max(ctx : Ptr[nk_context], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_window_get_content_region_min(ctx : Ptr[nk_context], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_window_get_content_region_size(ctx : Ptr[nk_context], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_window_get_position(ctx : Ptr[nk_context], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_window_get_size(ctx : Ptr[nk_context], __return : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_window_set_bounds(ctx : Ptr[nk_context], name : CString, bounds : Ptr[nk_rect]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_window_set_position(ctx : Ptr[nk_context], name : CString, pos : Ptr[nk_vec2]): Unit = extern

  private[nuklear] def __sn_wrap_nuklear_nk_window_set_size(ctx : Ptr[nk_context], name : CString, size : Ptr[nk_vec2]): Unit = extern
  ...
  def nk_strmatch_fuzzy_text(str : CString, str_len : CInt, pattern : CString, out_score : Ptr[CInt]): CInt = extern
...
object functions:
  ...
  def nk_color_cf(in : nk_color)(using Zone): nk_colorf = 
    val __ptr_0: Ptr[nk_color] = alloc[nk_color](1)
    val __ptr_1: Ptr[nk_colorf] = alloc[nk_colorf](1)
    !(__ptr_0 + 0) = in
    __sn_wrap_nuklear_nk_color_cf((__ptr_0 + 0), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  def nk_combo_begin_color(ctx : Ptr[nk_context], color : nk_color, size : nk_vec2)(using Zone): nk_bool = 
    ...
    !(__ptr_0 + 0) = color
    !(__ptr_1 + 0) = size
    __sn_wrap_nuklear_nk_combo_begin_color(ctx, (__ptr_0 + 0), (__ptr_1 + 0))
  ...
  def nk_do_button_image(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : nk_rect, img : nk_image, b : nk_button_behavior, style : Ptr[nk_style_button], in : Ptr[nk_input])(using Zone): nk_bool = 
    val __ptr_0: Ptr[nk_rect] = alloc[nk_rect](1)
    val __ptr_1: Ptr[nk_image] = alloc[nk_image](1)
    !(__ptr_0 + 0) = bounds
    !(__ptr_1 + 0) = img
    __sn_wrap_nuklear_nk_do_button_image(state, out, (__ptr_0 + 0), (__ptr_1 + 0), b, style, in)
  ...
  def nk_do_button_text_image(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], bounds : nk_rect, img : nk_image, str : CString, len : CInt, align : nk_flags, behavior : nk_button_behavior, style : Ptr[nk_style_button], font : Ptr[nk_user_font], in : Ptr[nk_input])(using Zone): nk_bool = 
    ...
    !(__ptr_0 + 0) = bounds
    !(__ptr_1 + 0) = img
    __sn_wrap_nuklear_nk_do_button_text_image(state, out, (__ptr_0 + 0), (__ptr_1 + 0), str, len, align, behavior, style, font, in)
  ...
  def nk_do_toggle(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], r : nk_rect, active : Ptr[nk_bool], str : CString, len : CInt, `type` : nk_toggle_type, style : Ptr[nk_style_toggle], in : Ptr[nk_input], font : Ptr[nk_user_font])(using Zone): nk_bool = 
    val __ptr_0: Ptr[nk_rect] = alloc[nk_rect](1)
    !(__ptr_0 + 0) = r
    __sn_wrap_nuklear_nk_do_toggle(state, out, (__ptr_0 + 0), active, str, len, `type`, style, in, font)

  def nk_do_toggle(state : Ptr[nk_flags], out : Ptr[nk_command_buffer], r : Ptr[nk_rect], active : Ptr[nk_bool], str : CString, len : CInt, `type` : nk_toggle_type, style : Ptr[nk_style_toggle], in : Ptr[nk_input], font : Ptr[nk_user_font]): nk_bool = 
    __sn_wrap_nuklear_nk_do_toggle(state, out, r, active, str, len, `type`, style, in, font)
  ...
  def nk_draw_image(b : Ptr[nk_command_buffer], r : nk_rect, img : Ptr[nk_image], col : nk_color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = r
    !(__ptr_0 + 0) = col
    __sn_wrap_nuklear_nk_draw_image(b, (__ptr_1 + 0), img, (__ptr_0 + 0))
  ...
  def nk_draw_nine_slice(b : Ptr[nk_command_buffer], r : nk_rect, slc : Ptr[nk_nine_slice], col : nk_color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = r
    !(__ptr_0 + 0) = col
    __sn_wrap_nuklear_nk_draw_nine_slice(b, (__ptr_1 + 0), slc, (__ptr_0 + 0))
  ...
  def nk_draw_symbol(out : Ptr[nk_command_buffer], `type` : nk_symbol_type, content : nk_rect, background : nk_color, foreground : nk_color, border_width : Float, font : Ptr[nk_user_font])(using Zone): Unit = 
    ...
    __sn_wrap_nuklear_nk_draw_symbol(out, `type`, (__ptr_1 + 0), (__ptr_0 + 0), (__ptr_0 + 1), border_width, font)
  ...
  def nk_draw_text(b : Ptr[nk_command_buffer], r : nk_rect, string : CString, length : CInt, font : Ptr[nk_user_font], bg : nk_color, fg : nk_color)(using Zone): Unit = 
    ...
    !(__ptr_0 + 0) = bg
    !(__ptr_0 + 1) = fg
    __sn_wrap_nuklear_nk_draw_text(b, (__ptr_1 + 0), string, length, font, (__ptr_0 + 0), (__ptr_0 + 1))
  ...
  def nk_fill_circle(b : Ptr[nk_command_buffer], r : nk_rect, c : nk_color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = r
    !(__ptr_0 + 0) = c
    __sn_wrap_nuklear_nk_fill_circle(b, (__ptr_1 + 0), (__ptr_0 + 0))
  ...
  def nk_fill_rect(b : Ptr[nk_command_buffer], rect : nk_rect, rounding : Float, c : nk_color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = rect
    !(__ptr_0 + 0) = c
    __sn_wrap_nuklear_nk_fill_rect(b, (__ptr_1 + 0), rounding, (__ptr_0 + 0))
  ...
  def nk_fill_rect_multi_color(b : Ptr[nk_command_buffer], rect : nk_rect, left : nk_color, top : nk_color, right : nk_color, bottom : nk_color)(using Zone): Unit = 
    val __ptr_0: Ptr[nk_color] = alloc[nk_color](4)
    val __ptr_1: Ptr[nk_rect] = alloc[nk_rect](1)
    !(__ptr_1 + 0) = rect
    !(__ptr_0 + 0) = left
    !(__ptr_0 + 1) = top
    !(__ptr_0 + 2) = right
    !(__ptr_0 + 3) = bottom
    __sn_wrap_nuklear_nk_fill_rect_multi_color(b, (__ptr_1 + 0), (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_0 + 3))
  ...
  def nk_image_color(ctx : Ptr[nk_context], img : nk_image, col : nk_color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = img
    !(__ptr_0 + 0) = col
    __sn_wrap_nuklear_nk_image_color(ctx, (__ptr_1 + 0), (__ptr_0 + 0))
  ...
  def nk_rgb_cf(c : nk_colorf)(using Zone): nk_color = 
    ...
    val __ptr_1: Ptr[nk_colorf] = alloc[nk_colorf](1)
    !(__ptr_1 + 0) = c
    __sn_wrap_nuklear_nk_rgb_cf((__ptr_1 + 0), (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  def nk_rgba_cf(c : nk_colorf)(using Zone): nk_color = 
    ...
    val __ptr_1: Ptr[nk_colorf] = alloc[nk_colorf](1)
    !(__ptr_1 + 0) = c
    __sn_wrap_nuklear_nk_rgba_cf((__ptr_1 + 0), (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  def nk_stroke_circle(b : Ptr[nk_command_buffer], r : nk_rect, line_thickness : Float, c : nk_color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = r
    !(__ptr_0 + 0) = c
    __sn_wrap_nuklear_nk_stroke_circle(b, (__ptr_1 + 0), line_thickness, (__ptr_0 + 0))
  ...
  def nk_stroke_rect(b : Ptr[nk_command_buffer], rect : nk_rect, rounding : Float, line_thickness : Float, c : nk_color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = rect
    !(__ptr_0 + 0) = c
    __sn_wrap_nuklear_nk_stroke_rect(b, (__ptr_1 + 0), rounding, line_thickness, (__ptr_0 + 0))
  ...
  def nk_subimage_handle(handle : nk_handle, w : nk_ushort, h : nk_ushort, r : nk_rect)(using Zone): nk_image = 
    ...
    val __ptr_1: Ptr[nk_image] = alloc[nk_image](1)
    !(__ptr_0 + 0) = r
    __sn_wrap_nuklear_nk_subimage_handle(handle, w, h, (__ptr_0 + 0), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  def nk_subimage_id(id : CInt, w : nk_ushort, h : nk_ushort, r : nk_rect)(using Zone): nk_image = 
    ...
    val __ptr_1: Ptr[nk_image] = alloc[nk_image](1)
    !(__ptr_0 + 0) = r
    __sn_wrap_nuklear_nk_subimage_id(id, w, h, (__ptr_0 + 0), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  def nk_subimage_ptr(ptr : Ptr[Byte], w : nk_ushort, h : nk_ushort, r : nk_rect)(using Zone): nk_image = 
    ...
    val __ptr_1: Ptr[nk_image] = alloc[nk_image](1)
    !(__ptr_0 + 0) = r
    __sn_wrap_nuklear_nk_subimage_ptr(ptr, w, h, (__ptr_0 + 0), (__ptr_1 + 0))
    !(__ptr_1 + 0)
